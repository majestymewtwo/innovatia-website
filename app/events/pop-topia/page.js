            ...
            <div className='flex flex-col space-y-3 h-3/5 lg:w-1/2 lg:h-4/5  lg:items-left overflow-y-clip'>
              ...
              <div className='pr-2 space-y-2 overflow-y-scroll scrollbar lg:text-sm'>
                <p className='font-semibold'>
                  ...
                  enthusiasts, showcasing diverse genres, and providing a
                ...
                <ul className='list-disc list-inside'>
                  <li>
                    ...
                    <div className='ml-5'>
                      The preliminary round will take place online via Gmeet.
                      The Cinematic Quizzes, powered by the Mentimeter platform,
                      will be conducted in 1 or 2 slots based on the number of
                  ...
                  <li>
                    ...
                    <div className='ml-5'>
                      ...
                      song earns 1 point.
                      <br />
                      4. Teams with the highest points proceed to the next
                      round.
                    </div>
                  </li>
                  <li>
                    ...
                    <div className='ml-5'>
                      ...
                      2. 2 minutes for the third (depends) member to identify
                      the movie.
                      <br />
                      3. 5 points for each correct movie guessed within the time
                      limit.
                      <br />
                      4. Teams with the most points move on to the following
                      round
                    </div>
                  </li>
                  <li>
                    ...
                    <div className='ml-5'>
                      ...
                      2. Each member receives a song with missing lyrics (1
                      word, 2 words, 3 words missing).
                      <br />
                  ...
                  <li>
                    Each round emphasizes different skills and teamwork,
                    offering an engaging and diverse challenge for the
                    participants.
                  </li>
                </ul>
                <p>
