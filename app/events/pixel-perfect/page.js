            ...
            <div className='flex flex-col space-y-3 h-3/5 lg:w-1/2 lg:h-4/5  lg:items-left overflow-y-clip'>
              ...
              <div className='pr-2 space-y-2 overflow-y-scroll scrollbar lg:text-sm'>
                <p className='font-semibold'>
                  ...
                  made with the camera… They are made with the eye, heart, TV,
                  and head.
                </p>
                <p>
                ...
                <p>
                  ...
                  <ul>
                    <li>Sri Sairam Engineering College, Chennai.</li>
                  </ul>
                </p>
                <p>
                ...
                <ul className='list-disc list-inside'>
                  <li>
                    ...
                    <div className='ml-5'>
                      ...
                      <br />
                      1. Participants must submit a photograph taken with their
                      mobile phones to the provided email or Google Form within
                      the given time frame.
                      <br />
                      2. Photographs must align with the announced themes
                      (Themes to be disclosed on the event day).
                      <br />
                      3. Top ten photographs will be selected for the next round
                      based on relevance to the theme and photography skills.
                    </div>
                  </li>
                  <li>
                    ...
                    <div className='ml-5'>
                      ...
                      <br />
                      2. Within the allocated time, participants should take a
                      photograph within the college premises, including a
                      geotag.
                      <br />
                      3. Top photographs will be selected and awarded based on
                      relevance to the theme and photography skills.
                    </div>
                  </li>
                </ul>
                <p>
                  <span className='font-bold'>Venue: </span>Sri Sairam
                  Engineering College
                </p>
