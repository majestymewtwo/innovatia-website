...
const EventDetailDB = () => {
  const onDownload = () => {
    ...
    link.download = `game-of-threats-brochure.png`;
    link.href = "/game-of-threats-brochure.png";
    link.click();
  };
    ...
    <>
     <div className='relative'>
      ...
      <section className="md:h-screen w-[100vw] flex justify-center items-center py-24 md:py-0">
        <div className="flex min-h-auto w-[90%]  md:min-h-[83%] lg:h-[80%] lg:justify-center">
            ...
            <div className="flex flex-col space-y-3 h-auto lg:w-3/5 lg:h-4/5 lg:items-left md:h-1/3 md:overflow-y-clip">
              ...
              <div className="pr-2 space-y-2 md:overflow-y-scroll scrollbar lg:text-sm">
                ...
                <div>
                  ...
                  <a href='https://chat.whatsapp.com/KaBqnRS1DNtI3QxbCUptM2' className="underline" target='_blank'>
