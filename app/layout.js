  ...
  return (
    <html lang='en'>
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;1,100;1,200;1,300;1,400;1,500;1,600&family=Righteous&display=swap" rel="stylesheet"></link>
      </head>
      <body>
        <Sidebar />
